...
public protocol StarknetAccountProtocol {
    ...
    func executeV1(calls: [StarknetCall], params: StarknetOptionalInvokeParamsV1) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse>
    ...
    ///
    /// - Returns: InvokeTransactionResponse, containing transaction hash of submitted transaction.
    func executeV3(calls: [StarknetCall], params: StarknetOptionalInvokeParamsV3) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse>
    ...
    ///
    /// - Returns: InvokeTransactionResponse, containing transaction hash of submitted transaction.
    func executeV1(calls: [StarknetCall], estimateFeeMultiplier: Double) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse>
    ...
    ///
    ///  - Returns: InvokeTransactionResponse, containing transaction hash of submitted transaction.
    func executeV3(calls: [StarknetCall], estimateAmountMultiplier: Double, estimateUnitPriceMultiplier: Double) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse>
    ...
    ///
    /// - Returns: InvokeTransactionResponse, containing transaction hash of submitted transaction.
    func executeV1(calls: [StarknetCall]) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse>
    ...
    ///
    /// - Returns: InvokeTransactionResponse, containing transaction hash of submitted transaction.
    func executeV3(calls: [StarknetCall]) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse>
    ...
    func estimateFeeV1(calls: [StarknetCall], nonce: Felt, skipValidate: Bool) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]>
    ...
    /// - Returns: struct containing fee estimate
    func estimateFeeV3(calls: [StarknetCall], nonce: Felt, skipValidate: Bool) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]>
    ...
    ///
    /// - Returns: struct containing fee estimate
    func estimateDeployAccountFeeV1(classHash: Felt, calldata: StarknetCalldata, salt: Felt, nonce: Felt, skipValidate: Bool) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]>
    ...
    ///
    /// - Returns: struct containing fee estimate
    func estimateDeployAccountFeeV3(classHash: Felt, calldata: StarknetCalldata, salt: Felt, nonce: Felt, skipValidate: Bool) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]>

    /// Get current nonce of the account
    ///
    /// - Returns: current nonce, as felt value.
    func getNonce() async throws -> any StarknetRequestProtocol<Felt>
}
...
public extension StarknetAccountProtocol {
    ...
    ///
    /// - Returns: InvokeTransactionResponse, containing transaction hash of submitted transaction.
    func executeV1(call: StarknetCall, params: StarknetOptionalInvokeParamsV1) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse> {
    ...
    ///
    /// - Returns: InvokeTransactionResponse, containing transaction hash of submitted transaction.
    func executeV3(call: StarknetCall, params: StarknetOptionalInvokeParamsV3) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse> {
    ...
    ///
    /// - Returns: InvokeTransactionResponse, containing transaction hash of submitted transaction.
    func executeV1(call: StarknetCall, estimateFeeMultiplier: Double) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse> {
    ...
    ///
    ///  - Returns: InvokeTransactionResponse, containing transaction hash of submitted transaction.
    func executeV3(call: StarknetCall, estimateAmountMultiplier: Double, estimateUnitPriceMultiplier: Double) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse> {
    ...
    ///
    /// - Returns: InvokeTransactionResponse, containing transaction hash of submitted transaction.
    func executeV1(call: StarknetCall) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse> {
    ...
    ///
    /// - Returns: InvokeTransactionResponse, containing transaction hash of submitted transaction.
    func executeV3(call: StarknetCall) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse> {
    ...
    /// - Returns: struct containing fee estimate
    func estimateFeeV1(calls: [StarknetCall], nonce: Felt) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    /// - Returns: struct containing fee estimate
    func estimateFeeV3(calls: [StarknetCall], nonce: Felt) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    /// - Returns: struct containing fee estimate
    func estimateFeeV1(calls: [StarknetCall], skipValidate: Bool = false) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    ///
    /// - Returns: struct containing fee estimate
    func estimateFeeV3(calls: [StarknetCall], skipValidate: Bool = false) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
        let nonce = try await getNonce().send()
    ...
    ///
    /// - Returns: struct containing fee estimate
    func estimateFeeV1(call: StarknetCall, nonce: Felt, skipValidate: Bool = false) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    ///
    /// - Returns: struct containing fee estimate
    func estimateFeeV3(call: StarknetCall, nonce: Felt, skipValidate: Bool = false) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    ///
    /// - Returns: struct containing fee estimate
    func estimateFeeV1(call: StarknetCall, skipValidate: Bool = false) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    ///
    /// - Returns: struct containing fee estimate
    func estimateFeeV3(call: StarknetCall, skipValidate: Bool = false) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    ///
    /// - Returns: struct containing fee estimate
    func estimateDeployAccountFeeV1(classHash: Felt, calldata: StarknetCalldata, salt: Felt, nonce: Felt = .zero) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    ///
    /// - Returns: struct containing fee estimate
    func estimateDeployAccountFeeV3(classHash: Felt, calldata: StarknetCalldata, salt: Felt, nonce: Felt = .zero) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
