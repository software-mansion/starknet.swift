...
public class StarknetAccount: StarknetAccountProtocol {
    ...
    public func executeV1(calls: [StarknetCall], params: StarknetOptionalInvokeParamsV1) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse> {
        var nonce: Felt
        var maxFee: Felt
    ...
    public func executeV3(calls: [StarknetCall], params: StarknetOptionalInvokeParamsV3) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse> {
        var nonce: Felt
    ...
    public func executeV1(calls: [StarknetCall], estimateFeeMultiplier: Double) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse> {
    ...
    public func executeV3(calls: [StarknetCall], estimateAmountMultiplier: Double, estimateUnitPriceMultiplier: Double) async throws -> any StarknetRequestProtocol<StarknetInvokeTransactionResponse> {
        let nonce = try await getNonce().send()
        let feeEstimate = try await estimateFeeV3(calls: calls, nonce: nonce).send()[0]
    ...
    public func estimateFeeV1(calls: [StarknetCall], nonce: Felt, skipValidate: Bool) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    public func estimateFeeV3(calls: [StarknetCall], nonce: Felt, skipValidate: Bool) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    public func estimateDeployAccountFeeV1(classHash: Felt, calldata: StarknetCalldata, salt: Felt, nonce: Felt, skipValidate: Bool) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    public func estimateDeployAccountFeeV3(classHash: Felt, calldata: StarknetCalldata, salt: Felt, nonce: Felt, skipValidate: Bool) async throws -> any StarknetRequestProtocol<[StarknetFeeEstimate]> {
    ...
    public func getNonce() async throws -> any StarknetRequestProtocol<Felt> {
