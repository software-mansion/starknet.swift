...
public struct StarknetSequencerInvokeTransaction: StarknetSequencerTransaction, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        senderAddress = try container.decode(Felt.self, forKey: .senderAddress)
        calldata = try container.decode(StarknetCalldata.self, forKey: .calldata)
        signature = try container.decode(StarknetSignature.self, forKey: .signature)
        maxFee = try container.decode(Felt.self, forKey: .maxFee)
        nonce = try container.decode(Felt.self, forKey: .nonce)
...
public struct StarknetInvokeTransaction: StarknetTransaction, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        maxFee = try container.decode(Felt.self, forKey: .maxFee)
        nonce = try container.decode(Felt.self, forKey: .nonce)
        hash = try container.decode(Felt.self, forKey: .hash)
...
public struct StarknetSequencerDeployAccountTransaction: StarknetSequencerTransaction, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        maxFee = try container.decode(Felt.self, forKey: .maxFee)
        nonce = try container.decode(Felt.self, forKey: .nonce)
        contractAddressSalt = try container.decode(Felt.self, forKey: .contractAddressSalt)
        constructorCalldata = try container.decode(StarknetCalldata.self, forKey: .constructorCalldata)
        classHash = try container.decode(Felt.self, forKey: .classHash)
