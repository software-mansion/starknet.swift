...
final class ProviderTests: XCTestCase {
    ...
    func testGetTransactionReceipt() async throws {
        ...
        let resAccDeploy = try await provider.getTransactionReceipt(txHash: acc.txHash)
        let resInvoke = try await provider.getTransactionReceipt(txHash: invoke.transactionHash)
