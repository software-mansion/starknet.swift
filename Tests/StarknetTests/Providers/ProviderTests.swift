...
final class ProviderTests: XCTestCase {
    ...
    func testGetChainId() async throws {
        let chainId = try await provider.send(request: StarknetRequest<StarknetChainId>.getChainId())

        XCTAssertEqual(chainId, .sepolia)
    }

    func testGetSpecVersion() async throws {
        let result = try await provider.send(request: StarknetRequest<String>.getSpecVersion())
    ...
    func testGetNonce() async throws {
        let nonce = try await provider.send(request: StarknetRequest<Felt>.getNonce(of: ProviderTests.devnetClient.constants.predeployedAccount1.address))

        print(nonce)
    }

    func testGetClassHash() async throws {
        let classHash = try await provider.send(request: StarknetRequest<Felt>.getClassHashAt(ethContractAddress))

        print(classHash)
    }

    func testGetBlockNumber() async throws {
        let blockNumber = try await provider.send(request: StarknetRequest<UInt64>.getBlockNumber())
    ...
    func testGetBlockHashAndNumber() async throws {
        ...
        let result = try await provider.send(request: StarknetRequest<StarknetBlockHashAndNumber>.getBlockHashAndNumber())
    ...
    func testGetEvents() async throws {
        ...
        let result = try await provider.send(request: StarknetRequest<StarknetGetEventsResponse>.getEvents(filter: filter))
    ...
    func testGetTransactionByBlockIdAndHash() async throws {
        let result = try await provider.send(request: StarknetRequest<TransactionWrapper>.getTransactionBy(blockId: .tag(.latest), index: 0))

        print(result)
    }

    func testGetTransactionByHash() async throws {
        let previousResult = try await provider.send(request: StarknetRequest<TransactionWrapper>.getTransactionBy(blockId: .tag(.latest), index: 0))

        let _ = try await provider.send(request: StarknetRequest<TransactionWrapper>.getTransactionBy(hash: previousResult.transaction.hash!))

        do {
            let _ = try await provider.send(request: StarknetRequest<TransactionWrapper>.getTransactionBy(hash: "0x123"))
    ...
    func testGetInvokeTransactionByHash() async throws {
        ...
        let result = try await provider.send(request: StarknetRequest<TransactionWrapper>.getTransactionBy(hash: transactionHash))
    ...
    func testGetDeployAccountTransactionByHash() async throws {
        ...
        let result = try await provider.send(request: StarknetRequest<TransactionWrapper>.getTransactionBy(hash: account.transactionHash))
    ...
    func testGetDeclareTransactionByHash() async throws {
        ...
        let result = try await provider.send(request: StarknetRequest<TransactionWrapper>.getTransactionBy(hash: contract.declare.transactionHash))
    ...
    func testGetTransactionStatus() async throws {
        ...
        let status = try await provider.send(request: StarknetRequest<StarknetGetTransactionStatusResponse>.getTransactionStatusBy(hash: contract.declare.transactionHash))
        let status2 = try await provider.send(request: StarknetRequest<StarknetGetTransactionStatusResponse>.getTransactionStatusBy(hash: contract.deploy.transactionHash))
    ...
    func testGetInvokeTransactionReceipt() async throws {
        ...
        let result = try await provider.send(request: StarknetRequest<TransactionReceiptWrapper>.getTransactionReceiptBy(hash: transactionHash))
    ...
    func testGetDeployAccountTransactionReceipt() async throws {
        ...
        let result = try await provider.send(request: StarknetRequest<TransactionReceiptWrapper>.getTransactionReceiptBy(hash: account.transactionHash))
        XCTAssertTrue(result.transactionReceipt.isSuccessful)
    }
    ...
    func testGetDeclareTransactionReceipt() async throws {
        ...
        let result = try await provider.send(request: StarknetRequest<TransactionReceiptWrapper>.getTransactionReceiptBy(hash: contract.declare.transactionHash))
        XCTAssertTrue(result.transactionReceipt.isSuccessful)
    }
    ...
    func testEstimateInvokeV1Fee() async throws {
        ...
        let _ = try await provider.send(request: StarknetRequest<[StarknetFeeEstimate]>.estimateFee(for: [tx1, tx2], simulationFlags: []))
        ...
        let _ = try await provider.send(request: StarknetRequest<[StarknetFeeEstimate]>.estimateFee(for: [tx1WithoutSignature, tx2WithoutSignature], simulationFlags: [.skipValidate]))
    }
    ...
    func testEstimateDeployAccountV1Fee() async throws {
        ...
        let _ = try await provider.send(request: StarknetRequest<[StarknetFeeEstimate]>.estimateFee(for: tx, simulationFlags: []))
        ...
        let _ = try await provider.send(request: StarknetRequest<[StarknetFeeEstimate]>.estimateFee(for: txWithoutSignature, simulationFlags: [.skipValidate]))
    }
    ...
    func testEstimateDeployAccountV3Fee() async throws {
        ...
        let _ = try await provider.send(request: StarknetRequest<[StarknetFeeEstimate]>.estimateFee(for: tx))
    ...
    func testEstimateMessageFee() async throws {
        ...
        let feeEstimate = try await provider.send(request: StarknetRequest<StarknetFeeEstimate>.estimateMessageFee(
            message,
    ...
    func testSimulateTransactionsV1() async throws {
        ...
        let accountClassHash = try await provider.send(request: StarknetRequest<Felt>.getClassHashAt(account.address))
        ...
        let simulations = try await provider.send(request: StarknetRequest<StarknetSimulationFlag>.simulateTransactions([invokeTx, deployAccountTx], at: .tag(.pending), simulationFlags: []))
        ...
        let simulations2 = try await provider.send(request: StarknetRequest<StarknetSimulationFlag>.simulateTransactions([invokeWithoutSignature, deployAccountWithoutSignature], at: .tag(.pending), simulationFlags: [.skipValidate]))
    ...
    func testBatchGetTransactionByHash() async throws {
        ...
        let transactionsResponse = try await provider.send(requests:
            StarknetRequest<TransactionWrapper>.getTransactionBy(hash: previousResult.transaction.hash!),
            StarknetRequest<TransactionWrapper>.getTransactionBy(hash: "0x123"))
