...
final class PoseidonTests: XCTestCase {
    func testPoseidonHashSingleZero() {
        ...
        let result = Poseidon.poseidonHash(zeroValue)
    ...
    func testPoseidonHashSingleOne() {
        ...
        let result = Poseidon.poseidonHash(oneValue)
    ...
    func testPoseidonHashSingleBigNumber() {
        ...
        let result = Poseidon.poseidonHash(value)
    ...
    func testPoseidonHashDoubleZero() {
        let zeroValue = Felt.zero
        let result = Poseidon.poseidonHash(first: zeroValue, second: zeroValue)
    ...
    func testPoseidonHashDoubleBigNumbers() {
        let value = Felt(BigUInt("737869762948382064636737869762948382064636737869762948382064636"))!
        let result = Poseidon.poseidonHash(first: value, second: value)
    ...
    func testPoseidonHashManyAllZeros() {
        let zeroValue = Felt.zero
        let result = Poseidon.poseidonHash(zeroValue, zeroValue, zeroValue)
    ...
    func testPoseidonHashManyBigNumbers() {
        ...
        let result = Poseidon.poseidonHash([value1, value2, value1])
    ...
    func testPoseidonHash4NumbersZeros() {
        let zeroValue = Felt.zero
        let result = Poseidon.poseidonHash(zeroValue, zeroValue, zeroValue, zeroValue)
    ...
    func testPoseidonHash10NumbersZeros() {
        let zeroValue = Felt.zero
        let result = Poseidon.poseidonHash(Array(repeating: zeroValue, count: 10))
